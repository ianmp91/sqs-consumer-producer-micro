...
COPY build/resources/main/public_key_b.pem src/main/resources/public_key_b.pem

# Copiamos el private key
COPY build/resources/main/private_key_c.pem src/main/resources/private_key_c.pem
